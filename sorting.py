...
if __name__ == '__main__':
    ...
    image_pub = rospy.Publisher('/object_sorting/image_result', Image, queue_size=1)
    ...
    # 保留图像订阅，执行 enter_func 初始化并订阅图像话题
    enter_func(None)

    # 直接设置目标，代替set_target服务回调
    class Msg:
        def __init__(self):
            self.color = ['red']
            self.tag = ['tag1']
